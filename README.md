...
**Note**: Depending on the height of the tower, the ball may not reach the ground in 5 seconds -- that’s okay. We’ll improve this program once we’ve covered loops. Note: The ^ symbol isn’t an exponent in C++. Implement the formula using multiplication instead of exponentiation. Note: Remember to use double literals for doubles, e.g. 2.0 rather than 2.

<br><br>


# My Thinking process
![](./practice-resources/my-solution-process.png)



### IMPORTANT
For thise project, i didn't use any loops, or more proper alternatives to IF statments because, i was following the course, and had to do what they asked,...